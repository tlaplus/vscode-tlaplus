...
export const TLC_CONFIG_PROPERTY_ACTION_LEVEL = registerCode(2272, TlcCodeType.Error);
export const TLC_CONFIG_PROPERTY_ACTION_LEVEL_SQUARE_A_SUB_V = registerCode(2273, TlcCodeType.Error);
export const TLC_CONFIG_PROPERTY_ACTION_LEVEL_ANGLE_A_SUB_V = registerCode(2274, TlcCodeType.Error);
